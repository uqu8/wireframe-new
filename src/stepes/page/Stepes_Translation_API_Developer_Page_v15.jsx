...
const startingPoints = [
  {
    ...
    href: "https://www.stepes.com/developers/translation-api/getting-started/",
  ...
  },
  {
    ...
    href: "https://www.stepes.com/developers/authentication/",
  ...
  },
  {
    ...
    href: "https://www.stepes.com/developers/translation-api/reference/",
  ...
  },
  {
    ...
    href: "https://www.stepes.com/developers/support/",
    link: "Get Developer Support",
    icon: "support",
  },
];
...
const documentationCategories = [
  {
    ...
    links: [
      [
        "API Overview",
        "https://www.stepes.com/developers/translation-api/getting-started/#api-overview",
      ],
      [
        "Quickstart",
        "https://www.stepes.com/developers/translation-api/getting-started/#quickstart",
      ],
      [
        "Environments and Base URLs",
        "https://www.stepes.com/developers/translation-api/getting-started/#environments-and-base-urls",
      ],
      [
        "Core Concepts",
        "https://www.stepes.com/developers/translation-api/core-concepts/",
      ],
    ],
  },
  {
    ...
    links: [
      [
        "API Credentials",
        "https://www.stepes.com/developers/authentication/#api-credentials",
      ],
      [
        "Permissions and Access",
        "https://www.stepes.com/developers/authentication/#permissions-and-access",
      ],
      [
        "Credential Security",
        "https://www.stepes.com/developers/authentication/#credential-security",
      ],
      [
        "Rotation and Revocation",
        "https://www.stepes.com/developers/authentication/#rotation-and-revocation",
      ],
    ],
  },
  {
    ...
    icon: "workflow",
    href: "https://www.stepes.com/developers/translation-api/workflows/",
    links: [
      [
        "Create Translation Projects",
        "https://www.stepes.com/developers/translation-api/workflows/#create-projects",
      ],
      [
        "Submit Translation Requests",
        "https://www.stepes.com/developers/translation-api/workflows/#submit-requests",
      ],
      [
        "Configure Workflow Options",
        "https://www.stepes.com/developers/translation-api/workflows/#workflow-options",
      ],
      [
        "Retrieve Status and Results",
        "https://www.stepes.com/developers/translation-api/workflows/#status-and-results",
      ],
    ],
  },
  {
    ...
    icon: "file",
    href: "https://www.stepes.com/developers/translation-api/files-and-content/",
    links: [
      [
        "Text Submission",
        "https://www.stepes.com/developers/translation-api/files-and-content/#text-submission",
      ],
      [
        "Document Upload",
        "https://www.stepes.com/developers/translation-api/files-and-content/#document-upload",
      ],
      [
        "Structured Content",
        "https://www.stepes.com/developers/translation-api/files-and-content/#structured-content",
      ],
      [
        "Validation and Requirements",
        "https://www.stepes.com/developers/translation-api/files-and-content/#validation-and-requirements",
      ],
    ],
  },
  {
    ...
    icon: "globe",
    href: "https://www.stepes.com/developers/translation-api/languages/",
    links: [
      [
        "Supported Languages",
        "https://www.stepes.com/developers/translation-api/languages/#supported-languages",
      ],
      [
        "Locale Identifiers",
        "https://www.stepes.com/developers/translation-api/languages/#locale-identifiers",
      ],
      [
        "Source-Language Handling",
        "https://www.stepes.com/developers/translation-api/languages/#source-language-handling",
      ],
      [
        "Target-Language Selection",
        "https://www.stepes.com/developers/translation-api/languages/#target-language-selection",
      ],
    ],
  },
  {
    title: "Project Status and Webhooks",
    description:
      "Track long-running translation jobs and build event-driven delivery workflows with status resources and webhooks.",
    icon: "pulse",
    href: "https://www.stepes.com/developers/translation-api/project-status/",
    links: [
      [
        "Project and Job States",
        "https://www.stepes.com/developers/translation-api/project-status/#project-and-job-states",
      ],
      [
        "Status Retrieval",
        "https://www.stepes.com/developers/translation-api/project-status/#status-retrieval",
      ],
      ["Webhook Events", "https://www.stepes.com/developers/webhooks/#events"],
      [
        "Signature Verification",
        "https://www.stepes.com/developers/webhooks/#signature-verification",
      ],
    ],
  },
  {
    ...
    icon: "alert",
    href: "https://www.stepes.com/developers/translation-api/errors/",
    links: [
      [
        "HTTP Status Codes",
        "https://www.stepes.com/developers/translation-api/errors/#http-status-codes",
      ],
      [
        "Structured Errors",
        "https://www.stepes.com/developers/translation-api/errors/#structured-errors",
      ],
      [
        "Retry Guidance",
        "https://www.stepes.com/developers/translation-api/errors/#retry-guidance",
      ],
      [
        "Rate and Usage Management",
        "https://www.stepes.com/developers/translation-api/rate-limits/",
      ],
    ],
  },
  {
    ...
    links: [
      [
        "Endpoint Directory",
        "https://www.stepes.com/developers/translation-api/reference/#endpoint-directory",
      ],
      [
        "Request and Response Schemas",
        "https://www.stepes.com/developers/translation-api/reference/#schemas",
      ],
      [
        "Examples and Errors",
        "https://www.stepes.com/developers/translation-api/reference/#examples-and-errors",
      ],
      [
        "Availability and Versions",
        "https://www.stepes.com/developers/translation-api/reference/#availability-and-versions",
      ],
    ],
  },
];
...
const relatedDeveloperResources = [
  {
  ...
  },
  {
    ...
    href: "https://www.stepes.com/developers/website-translation-proxy/",
  },
  {
  ...
  },
  {
    ...
    href: "https://www.stepes.com/developers/integrations/",
  },
  {
    title: "Webhooks",
    description:
      "Receive signed events for asynchronous processing, reviews, exceptions, and completed deliveries.",
    href: "https://www.stepes.com/developers/webhooks/",
  },
  {
    ...
    href: "https://www.stepes.com/developers/security/",
  },
];
...
const faqItems = [
  ...
  {
    question: "How do I obtain and protect API credentials?",
    answer:
      "API access is issued for approved integrations. Store credentials in a secure server-side secret manager, restrict them to authorized environments, rotate them when appropriate, and never expose them in public client code.",
    href: "https://www.stepes.com/developers/authentication/",
    link: "Review Authentication",
  },
  {
    question: "Does the API support both text and file translation?",
    answer:
      "The Translation API supports workflows for text, structured content, localization resources, business documents, and other supported inputs. Current formats, validation rules, and limits belong in the Files and Content documentation.",
    href: "https://www.stepes.com/developers/translation-api/files-and-content/",
    link: "Review Files and Content",
  },
  {
    question: "When should I use synchronous or asynchronous processing?",
    answer:
      "Use synchronous processing for eligible requests that can complete within the request lifecycle. Use asynchronous jobs for larger payloads, multiple target languages, file processing, professional review, or any workflow that may continue over time.",
    href: "https://www.stepes.com/developers/translation-api/workflows/",
    link: "Explore Translation Workflows",
  },
  {
    question:
      "Can a request include AI translation and professional human review?",
    answer:
      "Yes. Translation workflows can combine AI translation, professional translation, post-editing, linguistic review, terminology controls, translation memory, quality assurance, and approval based on the content and use case.",
    href: "https://www.stepes.com/developers/translation-api/workflows/",
    link: "Review Workflow Options",
  },
  {
    question: "How does an application know when a translation is complete?",
    answer:
      "Applications can retrieve job status and use signed webhook events for processing updates, review milestones, exceptions, and completed delivery. Integrations should handle duplicate events safely and reconcile results by job identifier.",
    href: "https://www.stepes.com/developers/webhooks/",
    link: "Review Webhooks",
  },
  {
    question:
      "How should an integration handle failures and duplicate requests?",
    answer:
      "Use structured errors, request identifiers, documented retry guidance, idempotency controls, and exponential backoff where supported. Do not retry validation or authentication failures without correcting the request.",
    href: "https://www.stepes.com/developers/translation-api/errors/",
  ...
  },
  {
    ...
    answer:
      "Developer support can help with use-case design, solution architecture, workflow configuration, security review, integration testing, production readiness, and troubleshooting.",
    href: "https://www.stepes.com/developers/support/",
...
export default function StepesTranslationApiDeveloperPage() {
  ...
  return (
    <div className="stepes-api-page">
      ...
      <main>
        ...
        <section className="hero" id="overview">
          <div className="shell hero-layout">
            <div className="hero-copy">
              <nav className="breadcrumb" aria-label="Breadcrumb">
                <a href="https://www.stepes.com/developers/">Developers</a>
              ...
              <p className="hero-lead">
                Connect your applications, content platforms, and enterprise
                systems to scalable translation and localization workflows with
                the Stepes API.
              </p>

              <p className="hero-support">
                Submit multilingual content, configure translation requirements,
                track processing, retrieve completed translations, and automate
                global content operations through one consistent developer
                framework.
              </p>
              ...
              <div className="hero-tertiary-links">
                <ArrowLink href="https://www.stepes.com/translation-api/">
                  Translation API Product Overview
                </ArrowLink>
              ...
              <div
                className="trust-row"
                aria-label="API documentation highlights"
              >
                <span>
            ...
            <div
              ...
              aria-label="Stepes translation API workflow"
            >
          ...
          <div className="local-nav-wrap">
            <nav className="shell local-nav" aria-label="On this page">
              ...
              <a
                className="active"
                href="https://www.stepes.com/developers/translation-api/#overview"
              >
                Overview
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#quickstart">
                Quickstart
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#documentation">
                Documentation
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#resources">
                API Resources
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#integrations">
                Integrations
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#security">
                Security
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#developer-tools">
                Developer Tools
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#integration-support">
                Support
              </a>
              <a href="https://www.stepes.com/developers/translation-api/#faq">
                FAQ
              </a>
            </nav>
          </div>
        ...
        {/* Section 2: Start Building with the Translation API */}
        <section className="starting-section" id="start-building">
          <div className="shell">
            <div className="section-intro">
              <h2>Start Building with the Translation API</h2>
              <p>
                Choose the technical path that matches your implementation
                stage, from secure access and first requests to endpoint-level
                reference and production support.
              </p>
            </div>
        ...
        {/* Section 3: How the Translation API Works */}
        <section className="framework-section" id="api-framework">
          <div className="shell">
            <div className="framework-intro">
              <h2>How the Translation API Works</h2>
              <p className="framework-lead">
                The Translation API uses a consistent resource and job model for
                content submission, workflow routing, status tracking, review,
                event delivery, and completed multilingual output.
              </p>
            ...
            <div className="framework-summary">
              <div>
                <h3>From Request Creation to Completed Delivery</h3>
                <p>
                  Implement one reliable end-to-end workflow first, then add
                  event handling, language assets, review stages, and
                  higher-volume operational controls.
                </p>
              </div>
        ...
        {/* Section 4: Send Your First Translation Request */}
          ...
          <div className="shell quickstart-layout">
            <div className="quickstart-copy">
              ...
              <p className="quickstart-lead">
                Follow a focused path from secure API access to completed
                multilingual output before adding advanced workflow
              ...
              <ArrowLink href="https://www.stepes.com/developers/translation-api/getting-started/">
            ...
            <div
              ...
              aria-label="Example first translation request"
            >
              ...
              >
                <div className="code-window-label">
                  <span>Illustrative Request Pattern</span>
  ...
  "target_locales": ["de-DE", "ja-JP"]
              ...
              <p className="code-example-note">
                Confirm production endpoint availability, authentication
                requirements, schemas, and environment details in the API
        ...
        {/* Section 5: Documentation by Category */}
        <section className="documentation-section" id="documentation">
          <div className="shell">
            <div className="section-intro documentation-intro">
              ...
              <p>
                Find the technical guidance, workflow documentation, and
                reference material needed to design, build, and operate your
                Stepes integration.
              </p>
            </div>
        ...
        {/* Section 6: Explore the Stepes API Resource Model */}
          ...
          <div className="shell">
            ...
            <div className="resource-model-layout">
              <div
                ...
                aria-label="Stepes API resource relationships"
              >
        ...
        {/* Section 7: Content and Workflow Configuration */}
        <section className="content-workflow-section" id="content-workflows">
          <div className="shell">
            <div className="section-intro content-workflow-intro">
              ...
              <h2>Configure Content, Context, and Quality</h2>
              <p>
                Submit text, structured content, software resources, documents,
                and recurring updates with the context, terminology, workflow,
                and review controls required for reliable multilingual output.
              </p>
            </div>
            ...
            <div className="content-workflow-layout">
              <div className="content-input-panel">
                <div className="subsection-heading">
                  ...
                  <p>
                    Bring multilingual processing closer to the systems where
                    your organization creates and manages content.
                  </p>
                </div>
                ...
                <div className="content-resource-links">
                  <ArrowLink href="https://www.stepes.com/developers/translation-api/files-and-content/">
                    Files and Content Documentation
                  </ArrowLink>
                  <ArrowLink href="https://www.stepes.com/developers/translation-api/languages/">
                    Languages and Locales
                  </ArrowLink>
                  <ArrowLink href="https://www.stepes.com/developers/translation-api/reference/">
                    Request Schemas
                  </ArrowLink>
                </div>
              </div>
              ...
              <div className="workflow-config-panel">
                <div className="workflow-config-heading">
                  ...
                  <p>
                    Configure translation and review steps according to business
                    risk, turnaround requirements, subject matter, and intended
                    use.
                  </p>
                </div>
                ...
                <div className="workflow-option-list">
                  {workflowOptions.map((item) => (
                    <article key={item.title}>
                      <span
                        className="workflow-option-marker"
                        aria-hidden="true"
                      >
                ...
                <div className="workflow-config-note">
                  ...
                  <p>
                    Developers work with a consistent API framework while
                    business and localization teams apply the appropriate
        ...
        <section className="integration-section" id="integrations">
          <div className="shell">
            <div className="section-intro integration-intro">
              ...
              <h2>Common Translation API Integration Patterns</h2>
              <p>
                Use stable identifiers, asynchronous jobs, webhook events, and
                predictable delivery patterns to connect translation workflows
                with the systems that create and manage content.
              </p>
            </div>
            ...
            <div className="integration-layout">
              <div className="integration-core">
                ...
                <p>
                  Submit content, configure workflows, monitor processing, and
                  return completed translations to the systems your teams
                  already use.
                </p>
            ...
            <div className="integration-links">
              <ArrowLink href="https://www.stepes.com/developers/integrations/">
                Integration Guides
              </ArrowLink>
              <ArrowLink href="https://www.stepes.com/developers/website-translation-proxy/">
                Website Translation Proxy
              </ArrowLink>
              <ArrowLink href="https://www.stepes.com/developers/software-localization-api/">
                Software Localization API
              </ArrowLink>
              <ArrowLink href="https://www.stepes.com/developers/webhooks/">
                Webhooks
              </ArrowLink>
            </div>
          </div>
        ...
        {/* Section 9: Security and Production Readiness */}
        <section className="reliability-section" id="security">
          <div className="shell">
            <div className="reliability-intro">
              ...
              <h2>Design Secure, Reliable Production Integrations</h2>
              <p>
                Protect credentials and content while designing for asynchronous
                processing, safe retries, request traceability, webhook
                verification, and verified multilingual delivery.
              </p>
            </div>
              ...
              <div className="reliability-column">
                <div className="reliability-column-heading">
                  ...
                  <div>
                    ...
                    <p>
                      Protect credentials, control access, and align API
                      activity with enterprise data-handling and governance
                      requirements.
                    </p>
                  </div>
                </div>
              ...
              <div className="reliability-column">
                <div className="reliability-column-heading">
                  ...
                  <div>
                    ...
                    <p>
                      Design for long-running workflows, predictable failures,
                      safe recovery, traceability, and verified multilingual
                      delivery.
                    </p>
                  </div>
                </div>
            ...
            <div className="reliability-links">
              ...
              <ArrowLink href="https://www.stepes.com/developers/translation-api/errors/">
        ...
        {/* Section 10: Developer Tools and API Lifecycle */}
        <section className="developer-tools-section" id="developer-tools">
          <div className="shell">
            <div className="section-intro developer-tools-intro">
              ...
              <p>
                Bring reference material, implementation guidance, API updates,
                and lifecycle information together in one consistent developer
                experience.
              </p>
            </div>
            ...
            <div className="developer-tools-layout">
              <div className="developer-tool-list">
                ...
                <div className="developer-tool-links">
                  ...
                  <ArrowLink href="https://www.stepes.com/developers/translation-api/examples/">
                    Explore Code Examples
                  </ArrowLink>
                  <ArrowLink href="https://www.stepes.com/developers/changelog/">
              ...
              <div className="api-lifecycle-panel">
                ...
                <p className="api-lifecycle-lead">
                  Clear lifecycle labels communicate the maturity, availability,
                  and support expectations of each API capability.
                </p>
                ...
                <div className="api-lifecycle-note">
                  ...
                  <p>
                    Version information, deprecation notices, replacement
                    guidance, and migration resources help enterprise teams plan
                    controlled updates.
                  </p>
                </div>

                <ArrowLink href="https://www.stepes.com/developers/migration-guides/">
        ...
        {/* Section 11: Enterprise Integration Support */}
        <section
          className="integration-support-section"
          id="integration-support"
        >
          <div className="shell">
            <div className="section-intro integration-support-intro">
              <h2>Get Implementation Support When You Need It</h2>
              <p>
                Work with Stepes developer and localization specialists on
                architecture, workflow design, security review, testing,
                production readiness, and operational optimization.
              </p>
            </div>
            ...
            <div className="support-cta-row">
              <div>
                <h3>Prepare a Reliable Production Integration</h3>
                <p>
                  Get technical guidance for architecture, workflow
                  configuration, security review, testing, launch, and
        ...
        {/* Section 12: Related Developer Documentation */}
        <section className="platform-section" id="platform">
          <div className="shell">
            <div className="section-intro platform-intro">
              <h2>Explore the Stepes Developer Ecosystem</h2>
              <p>
                Continue into shared developer services and adjacent Stepes
                integration products without leaving the developer documentation
                architecture.
              </p>
            </div>

            <div className="platform-directory">
              {relatedDeveloperResources.map((item) => (
                <article className="platform-item" key={item.title}>
                  <h3>{item.title}</h3>
                  <p>{item.description}</p>
                  <ArrowLink href={item.href}>Open {item.title}</ArrowLink>
                </article>
              ))}
            </div>
          </div>
        ...
        {/* Section 13: Translation API FAQ */}
        <section className="faq-section" id="faq">
          <div className="shell faq-layout">
            <div className="faq-intro">
              <h2>Translation API Questions</h2>
              <p>
                Review the implementation decisions developers most often need
                to make before moving into the detailed documentation.
              </p>
              <ArrowLink href="https://www.stepes.com/developers/support/">
                Contact Developer Support
              </ArrowLink>
            </div>
        ...
        <section className="final-cta-section" id="get-started">
          <div className="shell final-cta-panel">
            <div className="final-cta-copy">
              <h2>Start Building with the Translation API</h2>
              <p>
                Follow the quickstart to authenticate, submit content, monitor
                the translation job, handle completion events, and retrieve
            ...
            <div
              ...
              aria-label="Typical Translation API integration flow"
            >
              <div className="final-cta-diagram">
                <article className="final-cta-node">
                  <span className="final-cta-node-icon">
                    <Icon name="brackets" size={22} />
                  </span>
                  <strong>Your System</strong>
                  <small>CMS · PIM · Application</small>
                </article>

                <div className="final-cta-connector" aria-hidden="true">
                  <Icon name="arrow" size={18} />
                </div>

                <article className="final-cta-node final-cta-node-primary">
                  <span className="final-cta-node-icon">
                    <Icon name="workflow" size={22} />
                  </span>
                  <strong>Stepes Translation API</strong>
                  <small>Submit · Route · Review · Notify</small>
                </article>
                ...
                <article className="final-cta-node">
                  ...
                  <strong>Multilingual Content</strong>
                  <small>Retrieved and ready to publish</small>
                </article>
              </div>
            </div>
          </div>
...
const styles = `
  ...
  * {
  ...
  .hero-tertiary-links .arrow-link {
    min-height: 38px;
  }
  ...
  .final-cta-node-primary .final-cta-node-icon {
    color: #FFFFFF;
    background: var(--accent);
  }

  .final-cta-node strong,
  .final-cta-node small {
    display: block;
  }
  ...
  @media (max-width: 1199px) {
    ...
    .support-stage:nth-child(3n) {
      border-right: 0;
    }

    .support-stage:nth-last-child(-n + 2) {
      border-bottom: 0;
    }
  ...
  @media (max-width: 991px) {
    ...
    .platform-item:nth-last-child(-n + 2) {
      border-bottom: 0;
    }
