export default function StepesProductEngineeringWireframe() {
  ...
  const processRows = [
    ...
    },
    {
      ...
      href: "https://www.stepes.com/automatic-document-translation/",
    },
    {
  ...
  const relatedSolutions = [
    ...
    },
    {
      ...
      href: "https://www.stepes.com/help/translation-confidentiality-data-security-faqs/",
    },
  ];
      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-5 md:px-6 lg:px-10 xl:px-14">
        <section className="pb-20 pt-[96px] sm:pb-16 sm:pt-16 lg:pb-24 lg:pt-[104px]">
          <div className="mx-auto max-w-[860px] text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a
                href="https://www.stepes.com/contact-us/"
                className="inline-flex items-center justify-center rounded-full bg-[#C11D63] px-6 py-3 text-[16px] font-semibold text-white shadow-[0_12px_30px_rgba(193,29,99,0.18)] transition-colors hover:bg-[#A71954]"
              >
                Talk to a Product Localization Expert
              </a>
              <a
                href="https://www.stepes.com/software-translation-services/"
                className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-6 py-3 text-[16px] font-semibold text-slate-900 transition-colors hover:border-slate-300 hover:bg-slate-50"
              >
              ...
              <div className="grid gap-4 p-4 lg:p-5">
                <div className="rounded-[24px] border border-slate-200 bg-white p-4">
                  ...
                  <div className="mt-4 space-y-3 text-[15px] leading-6 text-slate-900">
                    <div className="flex items-start justify-between gap-4 rounded-[18px] bg-[#FDF2F7] px-3 py-3">
                      <span>Available balance</span>
                      <span className="font-medium text-[#9F1D55]">Saldo disponible</span>
                    </div>
                    <div className="flex items-start justify-between gap-4 rounded-[18px] bg-slate-50 px-3 py-3">
                ...
                <div className="rounded-[24px] border border-slate-200 bg-white p-4">
                  ...
                  <div className="mt-4 space-y-2 text-[15px] text-slate-900">
                    <div className="flex items-center justify-between rounded-[18px] bg-slate-50 px-3 py-3">
            ...
            <div className="grid sm:grid-cols-1 lg:grid-cols-4">
              {proofItems.map((item, index) => (
                ...
                >
                  ...
                  <h2 className="text-[20px] font-semibold leading-7 tracking-[-0.02em] text-slate-950">
                    {item.title}
                  </h2>
        ...
        <section className="pb-16 sm:pb-16 lg:pb-24">
          <div className="grid gap-10 xl:grid-cols-[0.86fr_1.14fr]">
            <div>
              ...
              <p className="mt-6 max-w-[620px] text-[18px] leading-8 text-slate-600">
                Product teams do not all localize the same way. Stepes supports API-enabled operations, structured file workflows, continuous release models, and managed multilingual delivery without overstating unsupported integrations.
              </p>
            </div>
          ...
          <div className="overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
            <div className="grid lg:grid-cols-2">
              {qaColumns.map((column, index) => (
                <div
                  key={column.title}
                  className={`px-6 py-6 sm:px-5 ${index % 2 === 0 ? "lg:border-r lg:border-slate-200" : ""} ${index < 2 ? "border-b border-slate-200" : ""}`}
                >
                  <h3 className="text-[22px] font-semibold leading-8 tracking-[-0.02em] text-slate-950">
                    {column.title}
                  </h3>
            ...
            <div className="grid xl:grid-cols-[0.82fr_1.18fr]">
              ...
              <div className="grid md:grid-cols-2">
                {governanceRows.map((row, index) => (
                  <div
                    key={row.title}
                    className={`px-6 py-6 sm:px-5 ${index % 2 === 0 ? "md:border-r md:border-slate-800" : ""} ${index < governanceRows.length - 2 ? "border-b border-slate-800" : ""}`}
                  >
          ...
          <div className="grid gap-10 xl:grid-cols-[0.86fr_1.14fr]">
            <div>
              ...
              <h2 className="max-w-[580px] text-[30px] font-semibold leading-[1.08] tracking-[-0.03em] text-slate-950 md:text-[32px] lg:text-[36px]">
                A Continuous SaaS Localization Program
              </h2>
              <p className="mt-6 max-w-[640px] text-[18px] leading-8 text-slate-600">
                A product team releasing new features every week may need to localize UI strings, help-center updates, developer content, and release notes across multiple languages without creating a separate manual process for every content stream.
              </p>
        ...
        <section className="pb-20 sm:pb-16 lg:pb-[112px]">
          <div className="relative overflow-hidden rounded-[32px] bg-[#7A1542] px-6 py-10 text-white shadow-[0_30px_80px_rgba(122,21,66,0.24)] sm:px-5 lg:px-10 lg:py-12">
            ...
            <div className="absolute -bottom-28 right-32 h-72 w-72 rounded-full bg-[#C11D63]/30" />
            <div className="relative grid gap-8 xl:grid-cols-[1fr_auto] xl:items-end">
              ...
              <div className="flex flex-wrap gap-4 xl:justify-end">
                <a
                  href="https://www.stepes.com/contact-us/"
                  className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-[16px] font-semibold text-[#7A1542] transition-colors hover:bg-[#FDF2F7]"
                >
                  Talk to a Product Localization Expert
                </a>
                <a
                  href="https://customer.stepes.com/instant-translation-quote/"
                  className="inline-flex items-center justify-center rounded-full border border-white/35 bg-white/10 px-6 py-3 text-[16px] font-semibold text-white transition-colors hover:bg-white/15"
                >
