  ...
  return (
    <div className="sesen-footer-logo-lockup">
      ...
      <style>{`
        ...
        .sesen-footer-logo-lockup__inner {
          width: 100%;
          max-width: 320px;
        }

        .sesen-footer-logo-lockup__logo {
          display: block;
          width: 146px;
          height: auto;
        }

        .sesen-footer-logo-lockup__tagline {
          margin-top: 10px;
          color: #17264d;
          font-size: 14px;
          line-height: 1.35;
        ...
        .sesen-footer-logo-lockup__rule {
          display: flex;
          align-items: center;
          margin-top: 12px;
          width: 236px;
        ...
        .sesen-footer-logo-lockup__rule-blue {
          width: 68px;
          height: 3px;
          background: #4b6fd8;
          border-radius: 999px;
        ...
        .sesen-footer-logo-lockup__rule-gray {
          width: 168px;
          height: 1px;
          background: #c8cfdd;
          flex: 0 0 auto;
